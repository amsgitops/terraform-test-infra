...
# ---------------------------------------------------------------------------
# Bastion host IAM role — grants SSM Session Manager access so the bastion
# can be reached via AWS Systems Manager as a fallback to SSH, and enables
# CloudWatch agent log shipping for session auditability.
# ---------------------------------------------------------------------------
